...
public class AboutInnerClasses {
    ...
    public void innerClassAndInheritance() {
        ...
        //assertEquals(someObject instanceof AboutInnerClasses, false);
    }
    ...
    public void staticInnerClass() {
        ...
        // What happens if you try to access 'x' or 'theAnswer' from the outer class? -- Not likely to be able to access instance vars
        // What does this mean for static inner classes?  - not linked to an instance
